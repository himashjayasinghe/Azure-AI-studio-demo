...
import Contoso from '../../assets/starbuks.svg'
          ...
          <div className={styles.chatContainer}>
            {!messages || messages.length < 1 ? (
              <Stack className={styles.chatEmptyState}>
                ...
                <h1 className={styles.chatEmptyStateTitle}>I'm Docu Bot !!!</h1>
                <h2 className={styles.chatEmptyStateSubtitle}>I can help with answer anything about Starbuks annual report from 2010 to 2020</h2>
              </Stack>
            ) : (
